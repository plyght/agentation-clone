...
export default function BunnyLogo({ className = "" }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <path
        className={`nav-ear-left-${animationPhase}`}
      ...
      />
      <path
        className={`nav-ear-right-${animationPhase}`}
      ...
      />
      <path
        className={animationPhase === "enter" ? "nav-face-enter" : ""}
      ...
      />
      <circle
        className={`nav-eye-left-${animationPhase}`}
        cx="8.277"
        cy="20.466"
        r="1.8"
        fill="rgba(0, 0, 0, 0.85)"
        style={{ transition: "fill 0.2s ease-out, opacity 0.2s ease-out" }}
      />
      <circle
        className={`nav-eye-right-${animationPhase}`}
        cx="19.878"
        cy="20.466"
        r="1.8"
        fill="rgba(0, 0, 0, 0.85)"
